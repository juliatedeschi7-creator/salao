...
export default function RelatoriosPage() {
  ...
  async function carregarDados() {
    ...
    const { data: srvs } = await supabase.from('servicos').select('id, nome')
  ...
  const totalComissoes = transacoes.reduce((a, t) => a + (t.comissao_valor || 0), 0)
  ...
  const totalRec = Object.values(receitasPorCategoria).reduce((a, b) => a + b, 0) || 1
  const totalProf = Object.values(receitasPorProfissional).reduce((a, b) => a + b, 0) || 1
    ...
    <div className="min-h-screen bg-[#f8f4f6] pb-8">
      ...
      <div className="px-4 py-4 flex flex-col gap-4">
        ...
        <div className="card flex flex-col gap-2">
          <p className="font-bold text-gray-900">Como calcular seu Lucro Real</p>
          <p className="text-xs text-gray-500">
            Receitas — Despesas — Comissões = Lucro Real
          </p>
